...
<body bgcolor="#FFFFFF" lang=CSlink=#000080 vlink=#800080 text="#000000">
	...
	<p>
		REQUEST UPDATE <?= $order->cancellation  ?>  <?= $user->name ?><br/>
		<?= $order->persons?> @lang('main.MAIL.PERSONS') - <?= $orders_detail_count ?> items - total <?= $orders_detail_total_price ?> <?= $currency ?> <br/>
