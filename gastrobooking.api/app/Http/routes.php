...
//    $api->get('invoice/get_invoice', 'App\Http\Controllers\InvoiceController@getInvoice');
    ...
    $api->group(['namespace' => 'App\Http\Controllers', 'middleware' => ['api.auth']], function ($api) {
        ...
        $api->post('prereg/confirmClient', 'PreregistrationController@confirmClient');
        $api->post('prereg/confirmedBusiness', 'PreregistrationController@confirmedBusiness');
         $api->post('prereg/cancelClient', 'PreregistrationController@cancelClient');
        $api->post('prereg/cancelBusiness', 'PreregistrationController@cancelBusiness'); 
